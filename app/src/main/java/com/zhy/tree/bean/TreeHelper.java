...
public class TreeHelper
{
...

	{
		...
		for (T t : datas)
		{
			...
			nodes.add(node);
			if (t instanceof MyBean.ListBean) {
				MyBean.ListBean listBean = (MyBean.ListBean) t;
				node.setDepa_id(listBean.depa_id);
				node.setDepa_employees_count(listBean.depa_employees_count);
				node.setRefBean((MyBean.ListBean) t);
			}
